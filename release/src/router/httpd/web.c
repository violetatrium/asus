...
static int get_basic_clientlist_info(webs_t wp, int val)
{
	...
	if(val == 3 && check_if_file_exist(NMP_CL_JSON_FILE))
	{
...
#if defined(CONFIG_BCMWL5) || defined(MAPAC2200) || defined(MAPAC2200P)
#ifndef RTCONFIG_QTN
...
#if !defined(RTCONFIG_QTN) && !defined(RTCONFIG_RALINK) && ((!defined(RTCONFIG_QCA)) || defined(MAPAC2200) || defined(MAPAC2200P)) && !defined(RTCONFIG_ALPINE) && !defined(RTCONFIG_LANTIQ)
