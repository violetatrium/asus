...
function initial(){
	...
	if(based_modelid == "MAP-AC1300" || based_modelid == "MAP-AC2200" || based_modelid == "MAP-AC1750" || based_modelid == "MAP-AC2200P"){
		...
		document.getElementById("switch_stb_x").options[4].text = portName.voip ;
		document.form.switch_stb_x.remove(6);
...
-->
		...
		<td><span id="iptv_port">LAN4 </span><span><input id="iptv_settings_btn" class="button_gen_long" type="button" onclick="set_connection('iptv');" value="IPTV Connection"></span><span id="iptv_configure_status" style="margin-left: 5px;display:none;">Unconfigured</span></td>
		</tr>
		<tr id="wan_voip_x">
		<th id="voip_title" width="30%">VoIP Port</th>
		<td><span id="voip_port">LAN3</span><span><input id="voip_settings_btn" class="button_gen_long" type="button" onclick="set_connection('voip');" value="VoIP Connection"><span id="voip_configure_status" style="margin-left: 5px; display:none;">Unconfigured</span></span>
	  	</td>
		</tr>
