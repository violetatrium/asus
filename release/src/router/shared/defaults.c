...
#ifdef RTCONFIG_IPV6
	{ "dns_probe_content", "131.107.255.255 112.4.20.71 fd3e:4f5a:5b81::1" },	// resolve target addr or wildcard *
#else
	{ "dns_probe_content", "131.107.255.255 112.4.20.71" },	// resolve target addr or wildcard *
#endif
	{ "dns_delay_round", "2" },
