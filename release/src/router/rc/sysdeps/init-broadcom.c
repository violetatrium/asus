...
#endif
#if defined(RTAC88U) || defined(RTAC3100) || defined(RTAC5300) || defined(RTAC3200)
	|| nvram_match("wan_proto", "pppoe") || nvram_match("wan0_proto", "pppoe") || nvram_match("wan1_proto", "pppoe")
#endif
