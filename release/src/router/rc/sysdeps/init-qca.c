...
#if defined(MAPAC1300) || defined(MAPAC2200) || defined(VZWAC1300) || defined(MAPAC2200P)
...
void config_switch(void)
{
	...
	case MODEL_MAPAC2200P:	/* fall through */
	...
	{ 
		...
		{ 
			...
			if (wlc_band != WL_60G_BAND) {
				...
				if (wlc_band==WL_5G_BAND || wlc_band==WL_5G_2_BAND)
					doSystem("wlanconfig %s create wlandev %s wlanmode sta nosbeacon",
						get_staifname(wlc_band^3), get_vphyifname(wlc_band^3));
#endif
			}
		}      
#endif
...
#if defined(RTCONFIG_REPEATER_SELECT5G)
				if (wlc_band==WL_5G_BAND || wlc_band==WL_5G_2_BAND)
					doSystem("wlanconfig %s destroy", get_staifname(wlc_band^3));
#endif
			}
#endif
		}      
...
#if defined(RTCONFIG_HAS_5G_2) || defined(MAPAC2200) || defined(MAPAC2200P)
...
#if defined(MAPAC2200) || defined(MAPAC2200P) || defined(RTCONFIG_HAS_5G_2)
...
#if defined(MAPAC2200) || defined(MAPAC1300) || defined(MAPAC2200P)
