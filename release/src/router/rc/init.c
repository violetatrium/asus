	...
	case MODEL_MAPAC2200:
		...
		if(nvram_safe_get("wan0_ifname")[0] == '\0' || sw_mode() != SW_MODE_ROUTER)
		{
			...
			if(sw_mode() == SW_MODE_ROUTER || nvram_match("cfg_master", "1"))
				...
				if (sw_mode()==SW_MODE_REPEATER)
					set_basic_ifname_vars("", "eth0 eth1 sta1 sta2", wl_ifaces, "usb", "eth0 eth1 sta1 sta2", "vlan2", "vlan3", NULL, 0);
				else
					set_basic_ifname_vars("", "eth0 eth1 sta1", wl_ifaces, "usb", "eth0 eth1 sta1", "vlan2", "vlan3", NULL, 0);
#else
				set_basic_ifname_vars("", "eth0 eth1 sta1", wl_ifaces, "usb", "eth0 eth1 sta1", "vlan2", "vlan3", NULL, 0);
...
#ifdef RTCONFIG_DUAL_BACKHAUL
#if defined(RTCONFIG_HIDDEN_BACKHAUL)
				set_basic_ifname_vars("", "vlan1 vlan2 sta0", wl_ifaces, "usb", "vlan1 vlan2 sta0", NULL, "vlan3", NULL, 0);
#else
...
#ifdef RTCONFIG_DUAL_BACKHAUL
#if defined(RTCONFIG_HIDDEN_BACKHAUL)
		set_basic_ifname_vars("vlan2", "vlan1 sta0", wl_ifaces, "usb", "vlan1 vlan2 sta0", NULL, "vlan3", NULL, 0);
#else
...
#ifdef RTCONFIG_DUAL_BACKHAUL
#if defined(RTCONFIG_HIDDEN_BACKHAUL)
		set_basic_ifname_vars("eth0", "eth1 sta0", wl_ifaces, "usb", "eth1 sta0", "vlan2", "vlan3", NULL, 0);
#else
		set_basic_ifname_vars("eth0", "eth1 sta0 sta1", wl_ifaces, "usb", "eth1 sta0 sta1", "vlan2", "vlan3", NULL, 0);
#endif
#else
...
#if !defined(RTCONFIG_DUALWAN) && \
    !(defined(MAPAC1300) || defined(MAPAC2200) || defined(VZWAC1300) || defined(MAPAC2200P)) && \
...
#if defined(MAPAC1300) || defined(MAPAC2200) || defined(VZWAC1300) || defined(MAPAC2200P) /* for NAND flash based Lyra */
...
#endif
#endif
#if defined(MAPAC1300) || defined(MAPAC2200) || defined(VZWAC1300) || defined(MAPAC2200P) /* for Lyra */
...
#elif defined(MAPAC1750)
	bt_reset = 8;
#elif defined(MAPAC2200) || defined(MAPAC2200P)
	bt_reset = 48;
#elif defined(BLUECAVE)
	bt_reset = 43;
#else
